...
// import * as Location from "expo-location";
// import haversine from "haversine";
// import PolylineDecoder from "@mapbox/polyline"; // decode Google directions polyline
// import { getAllCustomers, searchCustomers } from "../database";

// // ⚠️ Replace with your own Google Maps API key
...
//         setRouteCoords(coords);
//       } else {
//         Alert.alert("Route not found", "Cannot get directions.");
//       }
//     } catch (error) {
//       console.log("Directions error:", error);
...
//     // Distance
//     const dist = haversine(currentLocation, customerLoc, { unit: "km" }).toFixed(2);
//     setDistance(dist);

//     // Zoom map
//     if (mapRef.current) {
//       mapRef.current.fitToCoordinates([currentLocation, customerLoc], {
...
//     await fetchRoute(currentLocation, customerLoc);
