    ...
    />
      ...
      <ImageBackground source={require("../assets/bgBlue.png")} style={styles.bg2} >
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.title}>Recover payments.{"\n"}Rebuild clarity</Text>
          <Text style={styles.subtitle}>
            See pending invoices, send reminders,{"\n"}and get paid - all from one screen
          </Text>
...
const styles = StyleSheet.create({
  ...
  starLeft:{ position:"absolute", top:160, left:20, width:20, height:20, zIndex:50 },
  starRight:{ position:"absolute", top:320, right:-8, width:24, height:24, zIndex:50 },
  starBottom:{ position:"absolute", bottom:84, left:0, width:22, height:22, zIndex:50 },
